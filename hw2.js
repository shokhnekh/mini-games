...
//Задание 8. Создайте переменную age, присвойте ей значение с помощью метода prompt()«Сколько вам лет?».  выведите с помощью alert().
...
let userName = prompt('Ваше имя')ж
